			...
			if (
				...
				(T.container[0].swiper = T),
					...
					(T.params.nextButton || T.params.prevButton) &&
						(T.params.nextButton && ((T.nextButton = e(T.params.nextButton)), T.params.uniqueNavElements && "string" == typeof T.params.nextButton && T.nextButton.length > 1 && 1 === T.container.find(T.params.nextButton).length && (T.nextButton = T.container.find(T.params.nextButton))),
						T.params.prevButton && ((T.prevButton = e(T.params.prevButton)), T.params.uniqueNavElements && "string" == typeof T.params.prevButton && T.prevButton.length > 1 && 1 === T.container.find(T.params.prevButton).length && (T.prevButton = T.container.find(T.params.prevButton)))),
					...
					(T.updateClasses = function() {
						...
						T.params.loop ||
							(T.params.prevButton && T.prevButton && T.prevButton.length > 0 && (T.isBeginning ? (T.prevButton.addClass(T.params.buttonDisabledClass), T.params.a11y && T.a11y && T.a11y.disable(T.prevButton)) : (T.prevButton.removeClass(T.params.buttonDisabledClass), T.params.a11y && T.a11y && T.a11y.enable(T.prevButton))),
							T.params.nextButton && T.nextButton && T.nextButton.length > 0 && (T.isEnd ? (T.nextButton.addClass(T.params.buttonDisabledClass), T.params.a11y && T.a11y && T.a11y.disable(T.nextButton)) : (T.nextButton.removeClass(T.params.buttonDisabledClass), T.params.a11y && T.a11y && T.a11y.enable(T.nextButton))));
					}),
				...
				(T.onTouchStart = function(a) {
							...
							if ((z && T.emit("onTouchMove", T, a), !(a.targetTouches && a.targetTouches.length > 1))) {
								...
								if ((E && T.emit("onTouchMoveOpposite", T, a), void 0 === A && ((T.touches.currentX === T.touches.startX && T.touches.currentY === T.touches.startY) || (A = !0)), S)) {
									...
									if (A) {
										...
										var r = !0;
										if (
											(s > 0 && P > T.minTranslate() ? ((r = !1), T.params.resistance && (P = T.minTranslate() - 1 + Math.pow(-T.minTranslate() + I + s, T.params.resistanceRatio))) : s < 0 && P < T.maxTranslate() && ((r = !1), T.params.resistance && (P = T.maxTranslate() + 1 - Math.pow(T.maxTranslate() - I - s, T.params.resistanceRatio))),
										...
										T.params.followFinger &&
											((T.params.freeMode || T.params.watchSlidesProgress) && T.updateActiveIndex(), T.params.freeMode && (0 === G.length && G.push({position: T.touches[T.isHorizontal() ? "startX" : "startY"], time: M}), G.push({position: T.touches[T.isHorizontal() ? "currentX" : "currentY"], time: new window.Date().getTime()})), T.updateProgress(P), T.setWrapperTranslate(P));
									}
								}
							}
						}
					...
					(T.fixLoop = function() {
						...
						T.activeIndex < T.loopedSlides
							...
							: (("auto" === T.params.slidesPerView && T.activeIndex >= 2 * T.loopedSlides) || T.activeIndex > T.slides.length - 2 * T.params.slidesPerView) && ((e = -T.slides.length + T.activeIndex + T.loopedSlides), (e += T.loopedSlides), T.slideTo(e, 0, !1, !0));
					}),
										...
										i.each(function() {
											...
											T.loadImage(a[0], r || i, n, o, !1, function() {
												if (void 0 !== T && null !== T && T) {
													if (
														(i ? (a.css("background-image", 'url("' + i + '")'), a.removeAttr("data-background")) : (n && (a.attr("srcset", n), a.removeAttr("data-srcset")), o && (a.attr("sizes", o), a.removeAttr("data-sizes")), r && (a.attr("src", r), a.removeAttr("data-src"))),
					...
					(T.zoom = {
						...
						onGestureStart: function(a) {
							...
							if (
								!(
									...
									((t.gesture.slide = e(this)), 0 === t.gesture.slide.length && (t.gesture.slide = T.slides.eq(T.activeIndex)), (t.gesture.image = t.gesture.slide.find("img, svg, canvas")), (t.gesture.imageWrap = t.gesture.image.parent("." + T.params.zoomContainerClass)), (t.gesture.zoomMax = t.gesture.imageWrap.attr("data-swiper-zoom") || T.params.zoomMax), 0 !== t.gesture.imageWrap.length)
								)
							)
						...
						onGestureEnd: function(e) {
							...
							(!T.support.gestures && ("touchend" !== e.type || ("touchend" === e.type && e.changedTouches.length < 2))) ||
								(a.gesture.image && 0 !== a.gesture.image.length && ((a.scale = Math.max(Math.min(a.scale, a.gesture.zoomMax), T.params.zoomMin)), a.gesture.image.transition(T.params.speed).transform("translate3d(0,0,0) scale(" + a.scale + ")"), (a.currentScale = a.scale), (a.isScaling = !1), 1 === a.scale && (a.gesture.slide = void 0)));
						},
				...
				return (
					...
					(T.a11y = {
						...
						onEnterKey: function(a) {
							13 === a.keyCode &&
								(e(a.target).is(T.params.nextButton) ? (T.onClickNext(a), T.isEnd ? T.a11y.notify(T.params.lastSlideMessage) : T.a11y.notify(T.params.nextSlideMessage)) : e(a.target).is(T.params.prevButton) && (T.onClickPrev(a), T.isBeginning ? T.a11y.notify(T.params.firstSlideMessage) : T.a11y.notify(T.params.prevSlideMessage)),
